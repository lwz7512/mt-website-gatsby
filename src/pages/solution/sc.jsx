    ...
    <Layout activeMenu="solution">
      <div className="solutions-container">
          <div className="solutions-box">
              ...
              <div className="col-md-12 col-sm-12 solutions-text">
                  <p>Our high-speed ROV is used for underwater discovery will scan the ocean floor automatically which means the operator only need to release the ROV into water. Its revolutionary artificial intelligence (AI) makes the ROV incredibly self-sufficient and able to record and process sea cucumber distribution in real-time with relatively little human support.  With its unique ability to scan underwater, a density and distribution model of the sea cucumbers is going to be generated during operation via AI. This will give fisherman an informed solution by providing them with seafloor vision and a target map prior to their expeditions. This technical guidance with semi-automated operational ROV will allow for more sustainable and efficient harvest by allowing them to focus on the optimal fishing areas, increase catch rate, reduce damage to seabed floors and minimize wasted resources.</p>
              </div>

              <div className="col-md-12 col-sm-12 solutions-text">
                  <p>Our AI offers a minimally invasive solution to valuable gain insight into underwater behaviours of sea cucumbers and other species, as well as prevent unnecessary habitat destruction and unsustainable exploitation. The risk of habitat impact with current fishing strategies can be reduced through our ROV investigation and unveil sensitive habitat areas that may need protection, safeguarding the livelihood of the sea cucumber fisheries and marine ecosystems.</p>
              </div>
