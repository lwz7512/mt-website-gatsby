      ...
      <div className="solutions-container">
          <div className="solutions-box">
              <div className="solutions-big-title">
                  <span className="fisrt-text">S</span>mart Lobster Processing Plant
              </div>
              ...
              <div className="col-md-6 col-sm-12 solutions-img">
                <iframe className="cloud-video-frame" title="smart factory"
                    src="https://watch.cloudflarestream.com/fe656962703bfdd94c4e3bb889dc915c"></iframe>
              </div>
              ...
              <div className="col-md-12 col-sm-12 solutions-text">
                  <p>The first step in our factory is our AI Grading System. This is an innovative departure from the manual-human grading system that is still widely used in the fishing industry today.  It is designed to reduce operational costs, and drastically increase grading accuracy and efficiency up to 400%. Our AI Grading System is able to autonomously detect and classify the condition of the catch in real-time, for example weak lobster detection. </p>
              </div>

              <div className="col-md-12 col-sm-12 solutions-text">
                  <p>In order to control inventory and manage orders, we have developed an all-encompassing digitized Inventory Management System. This system has the ability to record and process all inventory related tasks, from the start to end of your product’s inventory life cycle. Our system imports the data collected during grading, and categorizes the inventory before sent to packing. During packing, a unique data tracking method is used to summarize all relevant history and data from the product grading, which is made accessible to the end-user in real-time. </p>
              </div>
